...
const ICON_PATHS: Record<string, React.ReactNode> = {
  ...
  repo: (
    <>
      <path d="M3 2h8a1 1 0 011 1v10a1 1 0 01-1 1H4a1 1 0 01-1-1V2z" />
      <path d="M3 11h9" />
    </>
  ),
  chat: (
    <>
      <path d="M2 4a2 2 0 012-2h8a2 2 0 012 2v6a2 2 0 01-2 2H7l-3 2v-2H4a2 2 0 01-2-2V4z" />
    </>
  ),
  settings: (
    <>
  ...
  filter: (
    <>
      <path d="M2 3h12l-4.5 5v5l-3 1V8L2 3z" />
    </>
  ),
  plus: (
    <>
  ...
  copy: (
    <>
      ...
      <path d="M11 11v2a1 1 0 01-1 1H3a1 1 0 01-1-1V6a1 1 0 011-1h2" />
    </>
  ),
  refresh: (
    <>
  ...
  attach: (
    <>
      <path d="M11 7l-5 5a2 2 0 11-3-3l6-6a3 3 0 014 4l-6 6" />
    </>
  ),
  branch: (
    <>
      ...
      <path d="M4 5v6" />
      <path d="M4 8c0-2 1-3 4-3 1.5 0 3 .5 3-1" />
    </>
  ),
  commit: (
    <>
  ...
  bot: (
    <>
      ...
      <circle cx="6.5" cy="9" r=".7" fill="currentColor" />
  ...
  sparkle: (
    <>
      <path d="M8 2l1.2 4 4 1.2-4 1.2L8 12.4 6.8 8.4l-4-1.2 4-1.2L8 2z" />
    </>
  ),
  play: (
    <>
  ...
  link: (
    <>
      <path d="M7 9a2.5 2.5 0 003.5 0L13 6.5a2.5 2.5 0 00-3.5-3.5L8 4.5" />
      <path d="M9 7a2.5 2.5 0 00-3.5 0L3 9.5a2.5 2.5 0 003.5 3.5L8 11.5" />
    </>
  ),
  flag: (
    <>
      <path d="M3 14V2" />
      <path d="M3 2h9l-2 3 2 3H3" />
    </>
  ),
  rerun: (
    <>
      <path d="M2 8a6 6 0 1010-4.5" />
      <path d="M14 2v4h-4" />
  ...
  zap: (
    <>
      <path d="M9 1L3 9h4l-1 6 6-8H8l1-6z" fill="currentColor" stroke="none" />
    </>
  ),
  key: (
    <>
  ...
  cookie: (
    <>
      <path d="M8 1.5a6.5 6.5 0 106.5 6.5c-1.5 0-2.5-1-2.5-2.5 0-1-1-2-2-2 0-1.5-1-2-2-2z" />
      <circle cx="6" cy="7" r=".5" fill="currentColor" />
      <circle cx="9.5" cy="10" r=".5" fill="currentColor" />
  ...
  api: (
    <>
      ...
      <path d="M5 7l1 1-1 1M9 7h2M9 9h2" />
    </>
  ),
  pause: (
    <>
  ...
  spider: (
    <>
      <circle cx="8" cy="8" r="2.5" />
      <path d="M8 5.5V2M8 10.5V14M5.5 8H2M10.5 8H14M6 6L3 3M10 10l3 3M6 10l-3 3M10 6l3-3" />
    </>
  ),
  link_off: (
    <>
      <path d="M7 9a2.5 2.5 0 003.5 0L11 8.5" />
      <path d="M9 7a2.5 2.5 0 00-3.5 0L5 7.5" />
      <path d="M2 2l12 12" />
    </>
  ),
  graph: (
  ...
  ide: (
    <>
      <rect x="2" y="3" width="12" height="10" rx="1.5" />
      <path d="M2 6h12" />
      <path d="M5 9l1.5 1.5L5 12M8 12h3" />
    </>
  ),
  shield_user: (
    <>
      ...
      <path d="M5.5 11c.5-1.5 1.5-2 2.5-2s2 .5 2.5 2" />
    </>
  ),
  audit: (
    <>
  ...
  brain: (
    <>
      <path d="M5.5 3.5a2.5 2.5 0 00-2 4 2.5 2.5 0 001 4 2 2 0 003 .5V4a2 2 0 00-2-.5z" />
      <path d="M10.5 3.5a2.5 2.5 0 012 4 2.5 2.5 0 01-1 4 2 2 0 01-3 .5V4a2 2 0 012-.5z" />
    </>
  ),
  triage: (
    <>
  ...
  threat: (
    <>
      <path d="M3 5l5-3 5 3v4c0 3-2 5-5 6-3-1-5-3-5-6V5z" />
  ...
  graphql: (
    <>
      ...
      <path d="M8 3.3l4.3 2.5v4.4L8 12.7l-4.3-2.5V5.8z" />
    </>
  ),
};
