...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/School/DoAnTotNghiep/central-dashboard/.gemini
                  → checks D:/School/DoAnTotNghiep/central-dashboard/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done
                  → writes to D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/hooks/
...
@D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
