...
Use template from `D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
