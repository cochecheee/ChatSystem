...
- **Global scope**: `D:/School/DoAnTotNghiep/central-dashboard/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/School/DoAnTotNghiep/central-dashboard/.gemini/notes/`)
...
2. Glob `D:/School/DoAnTotNghiep/central-dashboard/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (D:/School/DoAnTotNghiep/central-dashboard/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/School/DoAnTotNghiep/central-dashboard/.gemini/notes/` — works in any directory
