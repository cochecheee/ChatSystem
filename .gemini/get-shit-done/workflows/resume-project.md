...
<required_reading>
@D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" init resume)
