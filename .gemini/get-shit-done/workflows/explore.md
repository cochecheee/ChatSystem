...
@D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/questioning.md
...
```bash
node "D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
