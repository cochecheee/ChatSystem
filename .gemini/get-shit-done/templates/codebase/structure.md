...
- Usage: Reference from command with `@D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/School/DoAnTotNghiep/central-dashboard/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/School/DoAnTotNghiep/central-dashboard/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
