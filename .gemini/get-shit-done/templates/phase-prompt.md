...
<!-- For checkpoint task examples and patterns, see @D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/School/DoAnTotNghiep/central-dashboard/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
